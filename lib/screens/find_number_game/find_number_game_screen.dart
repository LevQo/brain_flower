          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: <Widget>[
                  TitleText(text: 'Найдите число 322', isCorrectAnswer: null),
                  SizedBox(height: 40.0),
                  Wrap(
                    spacing: MediaQuery.of(context).size.width * 0.1,
                    runSpacing: MediaQuery.of(context).size.height * 0.03,
                    children: <Widget>[
                      AnimatedNumberFindNumber(
                        type: NumberTypesFindNumbers.COLORFUL,
                        color: CustomColors.backgroundMoreLessColor,
                      ),
                      AnimatedNumberFindNumber(
...
class AnimatedNumberFindNumber extends StatefulWidget {
  ...
  const AnimatedNumberFindNumber({@required this.type, @required this.color});
  ...
  void initState() {
    switch (widget.type) {
      ...
      case NumberTypesFindNumbers.COLORFUL:
        ...
        var random = Random();
        var colorBegin = CustomColors.arrayColors[random.nextInt(10)];
        var colorEnd = CustomColors.arrayColors[random.nextInt(10)];
